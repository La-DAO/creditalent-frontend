        ...
        <div className="rounded-lg bg-gray-50 p-6 space-y-4">
          <div className="space-y-3 text-sm">
            <div className="flex items-center gap-2">
              <div className={`h-2.5 w-2.5 rounded-full ${getStatusColor(creditInfoData?.talent?.status)}`} />
            ...
            <div className="flex items-center gap-2">
              <div className={`h-2.5 w-2.5 rounded-full ${getStatusColor(creditInfoData?.usdc?.status)}`} />
            ...
            <div className="flex items-center gap-2">
              <div className={`h-2.5 w-2.5 rounded-full ${getStatusColor(creditInfoData?.xoc?.status)}`} />
              <span className="text-sm">{CREDIT_STATUS_LABEL[creditInfoData?.xoc?.status] ?? DEFAULT_CREDIT_STATUS_LABEL}</span>
            </div>
            <div className="flex justify-between">
              <span>3. XOC Available:</span>
